...
public class Messages {
    ...
    static let validCode = "Please enter a valid Code !".localized
    ...
    //MARK:- IntialPart
    static let txtWelcome = "Login".localized
    static let txtSignup = "SIGN UP".localized
    ...
    static let txtAppShareSkypeMessager = "⚡️ Join me on VIKFIT - The crossfitness training app!\n\nVIKFIT allows me to do crossfitness sessions indoors or at home. The application prepares me a 100% personalized sports program.\n\nThe application offers me new WODs made by professionals every day. Each exercise is well explained which allows even beginners to perform the movements well.\n\nVIKFIT is also a community of athletes, on which people support and encourage each other.\n\nJoin me quickly on VIKFIT, the application is available for free on the App store and the Google Play Store: www.vikfit.co".localized
    static let txtAppShareSubject = "⚡️ Join me on VIKFIT - The crossfitness training app!".localized
    static let txtAppShareMail = "⚡️Join me on VIKFIT - The crossfitness training app!\n\nVIKFIT allows me to do crossfitness sessions indoors or at home. The application prepares me a 100% personalized sports program.\n\nThe application offers me new WODs made by professionals every day. Each exercise is well explained which allows even beginners to perform the movements well.\n\nVIKFIT is also a community of athletes, on which people support and encourage each other.\n\nJoin me quickly on VIKFIT, the application is available for free on the App store and the Google Play Store: www.vikfit.co".localized
...
class CustomActivityItemProvider1: UIActivityItemProvider {
    ...
    let message = "\n\nJoin me on VIKFIT - The crossfitness training app!\n\nVIKFIT allows me to do crossfitness sessions indoors or at home. The app offers me new WODs made by professionals every week. Each exercise is well explained which allows even beginners to perform the movements well.\n\nVIKFIT is also a community of athletes, in which people support and encourage each other.\n\nJoin me quickly on VIKFIT, the application is available for free on the App Store and the Google Play Store: www.vikfit.co".localized
